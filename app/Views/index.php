...
<body>
  ...
  <div class="jumbotron">
    <div class="container">
      <h1 class="display-4"><span class="font-weight-bold">PROJEK AKHIR </span><br>PEMROGRAMAN WEB</h1>
      ...
      <form action="" method="POST">
        ...
        <br>
        <p1>Belum Punya Akun?</p1>
        <a href="register.php" class="text-primary">Daftar</p1>
      </form>
